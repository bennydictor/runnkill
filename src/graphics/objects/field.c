...
void init_field_object(int w, int h, int **bounds) {
    ...
    for (int i = 0; i < w; ++i) {
        for (int j = 0; j < h; ++j) {
            vertex3d box[4 * 6] = {
                {{i + 0,                0, j + 0}, {0, 0}, {-1, 0, 0}},
                {{i + 0, bounds[i][j] + 1, j + 0}, {0, 1}, {-1, 0, 0}},
                {{i + 0, bounds[i][j] + 1, j + 1}, {1, 1}, {-1, 0, 0}},
                {{i + 0,                0, j + 1}, {1, 0}, {-1, 0, 0}},

                {{i + 1,                0, j + 0}, {0, 0}, {+1, 0, 0}},
                {{i + 1, bounds[i][j] + 1, j + 0}, {0, 1}, {+1, 0, 0}},
                {{i + 1, bounds[i][j] + 1, j + 1}, {1, 1}, {+1, 0, 0}},
                {{i + 1,                0, j + 1}, {1, 0}, {+1, 0, 0}},
                ...
                {{i + 0, bounds[i][j] + 1, j + 0}, {0, 0}, {0, +1, 0}},
                {{i + 1, bounds[i][j] + 1, j + 0}, {0, 1}, {0, +1, 0}},
                {{i + 1, bounds[i][j] + 1, j + 1}, {1, 1}, {0, +1, 0}},
                {{i + 0, bounds[i][j] + 1, j + 1}, {1, 0}, {0, +1, 0}},

                {{i + 0,                0, j + 0}, {0, 0}, {0, 0, -1}},
                {{i + 1,                0, j + 0}, {0, 1}, {0, 0, -1}},
                {{i + 1, bounds[i][j] + 1, j + 0}, {1, 1}, {0, 0, -1}},
                {{i + 0, bounds[i][j] + 1, j + 0}, {1, 0}, {0, 0, -1}},

                {{i + 0,                0, j + 1}, {0, 0}, {0, 0, +1}},
                {{i + 1,                0, j + 1}, {0, 1}, {0, 0, +1}},
                {{i + 1, bounds[i][j] + 1, j + 1}, {1, 1}, {0, 0, +1}},
                {{i + 0, bounds[i][j] + 1, j + 1}, {1, 0}, {0, 0, +1}},
            };
